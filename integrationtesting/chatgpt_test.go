...
func TestChatGPTAPI(t *testing.T) {
	...
	chatgpt := integration.NewChatGPTClient("https://api.openai.com/v1/engines/text-davinci-003/completions", os.Getenv("CHATGPT_API_KEY"), integration.WithTimeout(1*time.Second))
